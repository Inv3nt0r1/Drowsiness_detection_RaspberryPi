...
# Date: 01-03-2019
#subject: This program tracks eye in the image and detects if it is open or closed. If closed for long time, it gives alert!
# Last edited: 18-12-2019

#References:
#   1) https://towardsdatascience.com/dont-sleep-building-your-first-drowsiness-detection-system-28a9903015f3
...
if args["alarm"] > 0:
    ...
    print("[INFO] using buzzer alarm... Testing Buzzer...")
...
#print("[INFO] parsing video from usb web cam...")
vs = VideoStream(usePiCamera=True).start()
print("[INFO] parsing video from local pi-cam")
time.sleep(1.0)
